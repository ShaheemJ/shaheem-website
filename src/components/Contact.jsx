...
const socialLinks = [
    {
      href: 'https://www.linkedin.com/in/shaheemjaleel',
                ...
                <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                    ...
                    <div className="flex items-center gap-2 mt-auto">
                        {socialLinks.map(({ href, icon }, key) => (
                            <a key={key} href={href} target="_blank" className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-950 active:big-zinc-50/80 reveal-up">
                                {icon}
                            </a>
                        ))}
                    </div>
                    ...
                    <form action="https://getform.io/f/ayvvoklb" method="POST" className="xl:pl-10 2xl:pl-20">
                        ...
                        <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                            ...
                            <input type="email" name="email" id="email" autoComplete="email" required placeholder="yourname@gmail.com" className="text-field reveal-up"/>
                            </div>
